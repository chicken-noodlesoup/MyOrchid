!(function (MyOrchid) {
    ...
    MyOrchid.Event = {
        preview: function (){
            ...
            `
            MyOrchid.body.insertAdjacentHTML('beforeend', eventPreviewModal);
        },
        delete: function (){
            ...
            `
            MyOrchid.body.insertAdjacentHTML('beforeend', eventDeleteModal);
        },
        form: function (){
            let eventFormModal = `
            ...
            `
            MyOrchid.body.insertAdjacentHTML('beforeend', eventFormModal);
        },
    }

    MyOrchid.Calendar = function (selector,events) {
        ...
        elm.forEach(item => {
            ...
            if(calendarEl != 'undefined' && calendarEl != null){
                let calendar = new FullCalendar.Calendar(calendarEl, {
                    timeZone: 'UTC',
                    initialView: MyOrchid.State.asMobile ? 'listWeek' : 'dayGridMonth',
                    ...
                    direction: MyOrchid.State.isRTL ? "rtl" : "ltr",
                    nowIndicator: true,
                    ...
                    eventClick: function(item){
                        ...
                        let startDateAlt = String(start.getDate()).padStart(2, '0') + ' ' + MyOrchid.monthList[start.getMonth()] + ' ' + start.getFullYear()
                        ...
                        let endDateAlt = String(end.getDate()).padStart(2, '0') + ' ' + MyOrchid.monthList[end.getMonth()] + ' ' + end.getFullYear()
                        ...
                        previewStart.innerText = `${startDateAlt}${startTime ? ' - ' + MyOrchid.to12(startTime) : ''}`;
                        previewEnd.innerText = `${endDateAlt}${endTime ? ' - ' + MyOrchid.to12(endTime) : ''}`;
                ...
                // init modal markups
                MyOrchid.Event.preview();
                MyOrchid.Event.delete();
                MyOrchid.Event.form();
                // init date picker
                MyOrchid.DatePicker('.fc-event-datepicker',{
                    buttonClass: 'btn',
                    autohide:true,
                    format: 'yyyy-mm-dd'
                });
                // init time picker
                MyOrchid.TimePicker('.fc-event-timepicker',{
                    format: 24,
                    interval : 30,
                    start : '00:00',
                    end : '23:30',
    ...
    MyOrchid.Calendar.init = function () {

        MyOrchid.Calendar('.js-calendar',[
            {
                id: 'default-event-id-' + Math.floor(Math.random()*9999999),
                title: 'Reader will be distracted',
                start: MyOrchid.Time.currentMonth() + '-03T13:30:00',
            ...
            },
            {
                ...
                start: MyOrchid.Time.currentMonth() + '-14T13:30:00',
                end: MyOrchid.Time.currentMonth() + '-14',
            ...
            },
            {
                ...
                start: MyOrchid.Time.currentMonth() + '-05',
                end: MyOrchid.Time.currentMonth() + '-06',
            ...
            },
            {
                ...
                start: MyOrchid.Time.currentMonth() + '-02',
                end: MyOrchid.Time.currentMonth() + '-04',
                className: "fc-event-primary",
                description: "Use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.",
            },
            {
                title: 'Gibmuza viib hepobe.',
                start: MyOrchid.Time.currentMonth() + '-12',
                end: MyOrchid.Time.currentMonth() + '-10',
            ...
            },
            {
                ...
                start: MyOrchid.Time.currentMonth() + '-07T16:00:00',
            ...
            },
            {
                id: 'default-event-id-' + Math.floor(Math.random()*9999999),
                title: 'Ke uzipiz zip.',
                start: MyOrchid.Time.currentMonth() + '-16T16:00:00',
                end: MyOrchid.Time.currentMonth() + '-14',
            ...
            },
            {
                ...
                start: MyOrchid.Time.today(),
                end: MyOrchid.Time.today() + '-01',
                className: "fc-event-primary",
                description: "Use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.",
            },
            {
                ...
                start: MyOrchid.Time.today() + 'T10:00:00',
            ...
            },
            {
                ...
                start: MyOrchid.Time.today() + 'T14:30:00',
            ...
            },
            {
                id: 'default-event-id-' + Math.floor(Math.random()*9999999),
                title: 'Play Time',
                start: MyOrchid.Time.today() + 'T17:30:00',
                className: "fc-event-info",
                description: "Use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.",
            },
            {
                ...
                start: MyOrchid.Time.yesterday() + 'T05:00:00',
                className: "fc-event-danger",
                description: "Use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden.",
            },
            {
                ...
                start: MyOrchid.Time.yesterday() + 'T07:00:00',
    ...
    MyOrchid.winLoad(MyOrchid.Calendar.init);
