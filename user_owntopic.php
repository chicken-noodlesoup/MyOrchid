...
<div id="main">
    <div class="container" style="margin-top: 100px;">
        <h3 class="pb-1 mb-4">My Topic</h3>
        <?php
            ...
            $sql = "SELECT * FROM discussion_topic 
                    ...
                    WHERE discussion_topic.user_id = $currentUserId
                    ORDER BY discussion_topic.timestamp DESC 
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class='card mb-4' onmouseover=\"this.style.backgroundColor='#f0f0f0';\" onmouseout=\"this.style.backgroundColor='white';\">
                        ...
                        <div class='card-header d-flex justify-content-between align-items-center'>
                            <a href='user_discussion_details.php?topic_id=$topic_id'>$topicTitle</a>
                        ...
                        <div class='card-body'>
                            ...
                            <div class='d-flex justify-content-between align-items-center'>
                                <div>
                                    ...
                                    <span class='ms-1'><a href='user_discussion_details.php?topic_id=$topic_id'><small>Reply</small></a></span>
                                </div>
...
<div class=" modal fade" id="AddDiscussion_Modal" tabindex="-1" aria-labelledby="modalFormLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalFormLabel">New Discussion Topic</h5>
    ...
    function deleteDiscussion(topicId) {
        if (confirm("Are you sure you want to delete this discussion?")) {
            // Perform an AJAX request to delete the discussion
            $.ajax({
                type: "POST",
                url: "code.php", 
                data: { deleteDiscussion: true, topic_id: topicId },
                success: function(response) {
                    
                    if (response.status === 200) {
                        alertify.set('notifier', 'position', 'top-right');
                        alertify.success("Discussion deleted successfully!");
                        // Optionally, remove the card from the UI
                        $("#discussionCard_" + topicId).remove();

                    } else {
                        alertify.set('notifier', 'position', 'top-right');
                        alertify.error("Failed to delete discussion. Please try again.");
                    }
                },
                error: function(jqXHR, textStatus, errorThrown) {
                    ...
                    alertify.set('notifier', 'position', 'top-right');
                    alertify.error("An error occurred while deleting the discussion.");
                }
            });
        }
    }
