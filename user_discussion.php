...
<div id="main">
    <div class="container" style="margin-top: 100px;">
        ...
        <div id="filterOptions" style="display: none;">
            ...
            <button class="btn btn-light">Care Tips</button>
            <button class="btn btn-light">Species Identification</button>
            <button class="btn btn-light">Blooming Cycles</button>
            <button class="btn btn-light">Orchid Species</button>
            <button class="btn btn-light">Pests And Diseases</button>
            <button class="btn btn-light">Growing Mediums</button>
            <button class="btn btn-light">Propagation Techniques</button>
            <button class="btn btn-light">Orchid Artistry</button>
