      ...
      <div class="container" style="margin-top: 100px; ">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-12 mb-4 ">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addPestModal">Add Pest and Diesease</button>
            </div>
                              ...
                              foreach($query_run as $pest)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $pest['pest_description'] ?></td>
                                        <td>
                                            <img src="data:image/jpeg;base64,<?= base64_encode($pest['pest_image']) ?>" alt="Pest Image" style="max-width:100px; max-height:100px;">
                                        </td>
                                        <td><?= $pest['pest_symptom'] ?></td>
                                        <td><?= $pest['pest_cause'] ?></td>
                                        <td><?= $pest['pest_preventions'] ?></td>
                                        <td><?= $pest['pest_solutions'] ?></td>
                                        <td>
                                            <button type="button" value="<?= $pest['pest_id']; ?>" class="editViewBtn btn btn-success btn-sm">View</button>
                                            <button type="button" value="<?= $pest['pest_id']; ?>" class="editPestBtn btn btn-success btn-sm">Edit</button>
                                            <button type="button" value="<?= $pest['pest_id']; ?>" class="deletePestBtn btn btn-danger btn-sm">Delete</button>
                                        </td>
                                    </tr>
                                    <?php
                                }
        ...
        <!-- Add Modal -->
        <!-- Add Modal -->
<div class="modal fade" id="addPestModal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel4">Add Pest Information</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" name="pest_name" class="form-control" placeholder="Enter Pest Name" />
                        </div>
                        <div class="col">
                            <label for="specific_names" class="form-label">Description</label>
                            <textarea name="pest_description" class="form-control" placeholder="Enter Pest Description"></textarea>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="inputfile" class="form-label">Upload Image</label>
                        <input type="file" class="form-control" name="pest_image" id="inputfile" aria-describedby="inputfile" accept="image/*" />
                    </div>
                    <!-- Image Preview Box -->
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <label for="pest_symptom" class="form-label">Symptom</label>
                            <textarea name="pest_symptom" class="form-control" placeholder="Enter Pest Symptom"></textarea>
                        </div>
                        <div class="col">
                            <label for="pest_cause" class="form-label">Cause</label>
                            <textarea name="pest_cause" class="form-control" placeholder="Enter Pest Cause"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                            <label for="pest_preventions" class="form-label">Preventions</label>
                            <textarea name="pest_preventions" class="form-control" placeholder="Enter Pest Preventions"></textarea>
                        </div>
                        <div class="col">
                            <label for="pest_solutions" class="form-label">Solutions</label>
                            <textarea name="pest_solutions" class="form-control" placeholder="Enter Pest Solutions"></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary">Save Pest</button>
                </div>
            </form>
        </div>
    </div>
