...
<div class="container" style="margin-top: 100px; padding-left: 55px; padding-right: 55px; ">
    ...
    <nav class="orchidcard">
        <h3 class="pb-1 mb-4 ">Pest and Disease Information</h3>
        ...
        <div class="row row-cols-1 row-cols-md-4 g-4 mb-5 " >
          ...
          <?php
            ...
            $countQuery = "SELECT COUNT(*) AS total FROM orchidpests";
            ...
            $sql = "SELECT * FROM orchidpests LIMIT $itemsPerPage OFFSET $offset";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    $pest_image = $row["pest_image"];

                    
                    if (empty($pest_image)) {
                        $imageBase64 = base64_encode(file_get_contents('img\no_image.jpg'));
                    } else {
                        $imageBase64 = base64_encode($pest_image);
                    }

                // Output the card HTML
                echo '<div class="col">
                      <a href="user_orchidpest_details.php?pest_id=' . $row['pest_id'] . '">
                      <div class="card h-100 "style= "background-color:#E8DACD;">
                              <div class="pest-item">
                                  <div class="square-container" style="height: 300px;">
                                      <img class="card-img-top card-image" src="data:image/jpeg;base64,' . $imageBase64 . '" alt="Card pest image" style="object-fit: cover; width: 100%; height: 100%;" />
                                  </div>    
                                  <div class="card-body" >
                                      <h5 class="card-title">' . $pest_name . '</h5>
                                  </div>
                              </div>
                          </div>
                          </a>
