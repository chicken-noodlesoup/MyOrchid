!function(e, t) {
    ...
    return function() {
        ...
        class Wo extends _n {
            render() {
                let {props: e, context: t} = this
                  , {options: n} = t
                  , {seg: r} = e
                  , i = Gr(r, n.eventTimeFormat || zo, t, !0, e.defaultDisplayEventEnd);
                return m(ps, Object.assign({}, e, {
                    elTag: "a",
                ...
                return m(ks, {
                    ...
                    popoverContent: ()=>{
                        ...
                        return m(y, null, t.map((t=>{
                            ...
                            }, Uo(t) ? m(Wo, Object.assign({
                                seg: t,
                                isDragging: !1,
                                isSelected: r === e.eventSelection,
                                defaultDisplayEventEnd: !1
                            }, Qr(t, e.todayRange))) : m(Lo, Object.assign({
                                seg: t,
                                isDragging: !1,
                                isResizing: !1,
                                isDateSelecting: !1,
        ...
        class Ko extends xi {
            ...
            render() {
                let {props: e, state: t, context: n} = this
                  , {options: r} = n
                  , i = e.cells.length
                  , s = Bo(e.businessHourSegs, i)
                  , o = Bo(e.bgEventSegs, i)
                  , a = Bo(this.getHighlightSegs(), i)
                  , l = Bo(this.getMirrorSegs(), i)
                      ...
                      , {singleColPlacements: h, multiColPlacements: f, leftoverMargins: g} = function(e, t, n) {
                        ...
                        for (let e = 0; e < n.length; e += 1) {
                            ...
                            for (let r of a) {
                                ...
                                s ? (d += r.thickness,
                                o && u.push({
                                    seg: $o(i, r.span.start, r.span.end, n),
                                    isVisible: !0,
                                    isAbsolute: !0,
                                    absoluteTop: r.levelCoord,
                                    marginTop: 0
                ...
                if (c)
                    for (let e of t) {
                        ...
                        h.push(m("div", {
                            ...
                            key: Zo(t),
                            ref: u ? null : this.segHarnessRefs.createRef(Xo(t)),
                            style: {
                                visibility: g ? "" : "hidden",
        ...
        class ea extends xi {
            constructor() {
                super(...arguments),
                this.splitBusinessHourSegs = Mt(Ho),
                this.splitBgEventSegs = Mt(Ho),
                this.splitFgEventSegs = Mt(Ho),
                this.splitDateSelectionSegs = Mt(Ho),
                this.splitEventDrag = Mt(jo),
                this.splitEventResize = Mt(jo),
                this.rowRefs = new ss
            }
            render() {
                let {props: e, context: t} = this
                ...
                return m(Wi, {
                    unit: "day"
                }, ((t,d)=>m(y, null, e.cells.map(((t,u)=>m(Ko, {
                    ...
                    component: class extends Va {
                        ...
                        render() {
                            let {options: e, dateEnv: t, dateProfileGenerator: n} = this.context
                              ...
                              , h = !1 !== e.allDaySlot && (t=>m(ia, Object.assign({}, o.allDay, {
                                dateProfile: i,
                                dayTableModel: s,
                                nextDayThreshold: e.nextDayThreshold,
                                tableMinWidth: t.tableMinWidth,
